...
const aggregateData = (data, selectedcountry) => {
...
const PieChartCountryWiseSectoronRelevance = ({ data, selectedcountry }) => {
  const d3Container = useRef(null);

  useEffect(() => {
    if (data.length > 0) {
      const aggregatedData = aggregateData(data, selectedcountry);
...
export default PieChartCountryWiseSectoronRelevance;
