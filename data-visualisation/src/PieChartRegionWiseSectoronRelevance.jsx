...
const aggregateData = (data, selectedregion) => {
...
const PieChartRegionWiseSectoronRelevance = ({ data, selectedregion }) => {
  const d3Container = useRef(null);

  useEffect(() => {
    if (data.length > 0) {
      const aggregatedData = aggregateData(data, selectedregion);
...
export default PieChartRegionWiseSectoronRelevance;
